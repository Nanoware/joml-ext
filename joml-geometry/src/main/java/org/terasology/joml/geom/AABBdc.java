...
/**
 * Interface to a read-only view of axis-aligned box defined via the minimum and maximum corner coordinates as
...
public interface AABBdc {
     ...
     * Double#POSITIVE_INFINITY} and the maximum coordinates will have a value of {@link Double#NEGATIVE_INFINITY}.
     *
     ...
     * @return {@link Intersectiond#INSIDE} if the line segment lies completely inside of this AABB; or {@link
     *         Intersectiond#OUTSIDE} if the line segment lies completely outside of this AABB; or {@link
     *         Intersectiond#ONE_INTERSECTION} if one of the end points of the line segment lies inside of this AABB; or
     *         {@link Intersectiond#TWO_INTERSECTION} if the line segment intersects two sides of this AABB or lies on
    ...
    /**
     * Apply the given {@link Matrix4dc#isAffine() affine} transformation to this {@link AABBd} and store the resulting
